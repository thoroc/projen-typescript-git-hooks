...
describe("Vitest", () => {
  describe("devDependencies", () => {
    it("adds vitest", () => {
      ...
      expect(Object.keys(snapshot["package.json"].devDependencies)).toContain("vitest");
    });
    ...
    it("adds @vitest/coverage-v8 by default", () => {
      ...
      const snapshot = synthSnapshot(project);
      expect(Object.keys(snapshot["package.json"].devDependencies)).toContain("@vitest/coverage-v8");
    });
